...
var partyOrdering = [
    ...
    {
        partyID: JJUProgressiveParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    { partyID: JJUGreenParty.getID(), direction: PieChartDirection.clockwise },
    {
        partyID: JJUCitrusPartyBloc.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: JJUProgressiveLabourParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    { partyID: JJULabourParty.getID(), direction: PieChartDirection.clockwise },
    {
        partyID: JJULabLibPartyBloc.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: JJUPeacockPartyBloc.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: JJUUnitedLeftBloc.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: FederalistParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: Independent1860JohnBreckenridgeParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: DemocraticParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    { partyID: GreenParty.getID(), direction: PieChartDirection.clockwise },
    {
        partyID: IndependentRNParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: Independent1824AJParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: Independent1824WCParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    { partyID: FreeSoilParty.getID(), direction: PieChartDirection.clockwise },
    {
        partyID: Independent1932NTParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: Independent1948SMParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: Independent1948HWParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: Independent1956WJParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: Independent1960HBParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: Independent1968GWParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: Independent1976EMParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: Independent1988LBParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: Independent2004JEParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: Independent2016SEParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: Independent2016JKParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: Independent2016RPParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: Independent2016BSParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: Independent2016CPParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: Independent2016EMParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
        partyID: IndependentGWParty.getID(),
        direction: PieChartDirection.clockwise,
    },
    {
    ...
    {
        partyID: Independent1808GCParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: Independent1820JAParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: Independent1824HCParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: Independent1832JFParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: Independent1832WWParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: Independent1836WMParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: Independent1836DWParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: Independent1836HWParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: Independent1844JBParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: Independent1856MFParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: Independent1860JohnBellParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: Independent1888CFParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: Independent1892JBParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: Independent1892JWParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: Independent1912EDParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: Independent1916ABParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: Independent1920EDParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: Independent1924RLParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: Independent1976RRParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: Independent1980JAParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: ReformParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: LibertarianParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: RepublicanParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: Independent1912TRParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: WhigParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: NationalRepublicanParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: DemocraticRepublicanParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: JJUUnityPartyBloc.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: JJUReformParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: JJULiberalParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: JJULibConPartyBloc.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: JJULabourConPartyBloc.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: JJUAllianceParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: JJUWildroseParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
    {
        partyID: JJUNationalParty.getID(),
        direction: PieChartDirection.counterclockwise,
    },
];
...
function setupTotalsPieChart() {
    for (
        let customPartyOn = 1;
        customPartyOn <= maxPartiesToDisplay;
        customPartyOn++
    ) {
        insertPartyIntoTotalsPieChartOrdering(
            customPartyIDPrefix + customPartyOn,
        );
    }
        ...
        plugins: {
            tooltip: {
                ...
                external: function (context) {
                    ...
                    charttooltipHTML += tooltipModel.title
                        .map((title) => "<div>" + title + "</div>")
                        .join("");
                    charttooltipHTML += tooltipModel.body
                        .map(
                            (bodyInfo, i) =>
                                "<div style='color: " +
                    ...
                    let { left: xPos, top: yPos } =
                        context.chart.canvas.getBoundingClientRect();
                    xPos += tooltipModel.caretX;
                    yPos += tooltipModel.caretY;

                    xPos = correctOverflow(
                        xPos,
                        $("#charttooltipcontainer").width(),
                        $(document).width(),
                    );
                    yPos = correctOverflow(
                        yPos,
                        $("#charttooltipcontainer").height(),
                        $(document).height(),
                    );
                ...
                callbacks: {
                    title: function (tooltipItems) {
                        ...
                        switch (tooltipItem.datasetIndex) {
                            ...
                            case 2:
                                label +=
                                    getRoundedMarginValue(
                                        tooltipItem.dataset.data[
                                            tooltipItem.dataIndex
                                        ],
                                    ) + currentMapSource.getVoteshareSuffix();
                                break;
                        }
                    ...
                    label: function (tooltipItem) {
                        switch (tooltipItem.datasetIndex) {
                            ...
                            case 1:
                                var regionPartyStringArray =
                                    regionPartyStrings[tooltipItem.dataIndex];
                                if (regionPartyStringArray) {
                                    return regionPartyStringArray.concat();
                                }
                                return null;
                    ...
                    labelTextColor: function (tooltipItem) {
                        var backgroundColors =
                            tooltipItem.chart.config.data.datasets[
                                tooltipItem.datasetIndex
                            ].backgroundColor;
                        var indexToUse = tooltipItem.dataIndex;
                        if (
                            tooltipItem.datasetIndex == 1 &&
                            typeof backgroundColors[indexToUse] !== "string"
                        ) {
                            if (
                                partyOrdering[Math.floor(indexToUse / 2)]
                                    .direction == PieChartDirection.clockwise
                            ) {
                                indexToUse -= 1;
                            } else {
                        ...
                        return adjustBrightness(
                            color,
                            minTotalsPieChartSliceLabelBrightness,
                        );
                    },
                },
            },
            datalabels: {
                color: function (context) {
                    ...
                    return value == 0 ||
                        value <
                            Math.floor(
                                minTotalsPieChartSliceLabelPercent * evSum,
                            )
                        ? "rgb(0, 0, 0, 0)"
                        : "#fff";
                },
                font: function (context) {
                    var numberOfShownDatasets =
                        context.chart.config.data.datasets.reduce(
                            (shownCount, dataset) =>
                                shownCount + (dataset.hidden ? 0 : 1),
                            0,
                        );
                    ...
                    switch (context.datasetIndex) {
                        ...
                        case 1:
                            return {
                                family: "BreeSerif-Mono",
                                size: Math.round(
                                    (fontFactor *
                                        24 *
                                        $("#totalsPieChart").width()) /
                                        450,
                                ),
                                weight: "bold",
                            };
    ...
    for (let partyNum in fullPartyOrdering) {
        ...
        if (partyID != TossupParty.getID()) {
            if (politicalParties[partyID] != null) {
                let marginNames = Object.keys(
                    cloneObject(politicalParties[partyID].getMarginNames()),
                );
                if (
                    fullPartyOrdering[partyNum].direction ==
                    PieChartDirection.counterclockwise
                ) {
                    marginNames.reverse();
                }
                ...
                for (let marginKeyNum in marginNames) {
                    ...
                    marginSectionBackgroundColors.push(
                        politicalParties[partyID].getMarginColors()[marginKey],
                    );
                    marginSectionLabels.push(
                        politicalParties[partyID].getMarginNames()[marginKey] +
                            " " +
                            politicalParties[partyID].getShortName(),
                    );
                }

                partySectionData.push(0);
                partySectionData.push(0);
                partySectionLabels.push(
                ...
                let colorPattern = createHashCanvasPattern(
                    politicalParties[partyID].getMarginColors().safe,
                );
                if (
                    fullPartyOrdering[partyNum].direction ==
                    PieChartDirection.clockwise
                ) {
                    partySectionBackgroundColors.push(
                        politicalParties[partyID].getMarginColors().safe,
                    );
                ...
                popularVoteSectionBackgroundColors.push(
                    politicalParties[partyID].getMarginColors().safe,
                );
                popularVoteSectionLabels.push(
                    politicalParties[partyID].getNames()[0],
                );
            } else {
            ...
            marginSectionBackgroundColors.push(
                TossupParty.getMarginColors().safe,
            );
...
function createHashCanvasPattern(baseColor) {
    ...
    patternContext.fillStyle = multiplyBrightness(
        baseColor,
        flipPatternBrightnessFactor,
    );
    ...
    let colorPattern = document
        .getElementById("totalsPieChart")
        .getContext("2d")
...
function updateTotalsPieChart() {
    let shouldGetOriginalMapData =
        currentMapSource.getShouldUseOriginalMapDataForTotalsPieChart();
    let regionDataArray =
        shouldGetOriginalMapData && currentSliderDate
            ? currentMapSource.getMapData()[currentSliderDate.getTime()]
    ...
    for (let regionID in regionDataArray) {
        if (
            regionID == nationalPopularVoteID ||
            regionID.endsWith(subregionSeparator + statePopularVoteDistrictID)
        ) {
            continue;
        }
        ...
        if (
            regionParty != null &&
            !fullPartyOrdering.some(
                (orderingData) => orderingData.partyID == regionParty,
            )
        ) {
            insertPartyIntoTotalsPieChartOrdering(
                regionParty,
            ...
            for (let marginKey in politicalParties[
                regionParty
            ].getMarginNames()) {
        ...
        let regionEV =
            currentMapType.getEV(
                getCurrentDecade(),
                regionID,
                regionDataArray[regionID],
            ) ?? regionDataArray[regionID].voteWorth;
        let formattedRegionMargin = getRoundedMarginValue(regionMargin);
        let regionString =
            (currentMapSource.getFormattedRegionName
                ? currentMapSource.getFormattedRegionName(regionID)
                : regionID) +
            " " +
            currentMapSource.getVotesharePrefix() +
            formattedRegionMargin +
            (currentMapSource.getCustomVoteshareSuffix() ?? "");

        if (
            regionParty == null ||
            regionParty == TossupParty.getID() ||
            regionMargin == 0
        ) {
            marginTotalsData[TossupParty.getID()].safe += regionEV;
            regionMarginStringsData[TossupParty.getID()].safe.push(
                regionString,
            );
        } else {
            let marginKey = getMarginIndexForValue(
                regionMargin,
                regionDataArray[regionID],
            );
    ...
    for (partyNum in regionMarginStringsData) {
        for (let marginKey in regionMarginStringsData[partyNum]) {
            regionMarginStringsData[partyNum][marginKey].sort(
                (marginString1, marginString2) => {
                    return parseFloat(marginString1.split("+")[1]) >
                        parseFloat(marginString2.split("+")[1])
                        ? 1
                        : -1;
                },
            );
    ...
    for (partyNum in fullPartyOrdering) {
        ...
        if (partyID != TossupParty.getID()) {
            ...
            for (let marginKeyNum in marginNames) {
                ...
                if (
                    marginKey == "current" &&
                    currentMapType.getMapSettingValue("pieCurrentSeats") ===
                        false
                ) {
                    marginTotalsArray.push(0);
                } else {
                    marginTotalsArray.push(
                        marginTotalsData[partyID][marginKey],
                    );
                }

                if (marginKey == "safe") {
                    safeMarginTotalsArray.push(
                        marginTotalsData[partyID][marginKey],
                    );
                }
            }
    ...
    for (let partyNum in fullPartyOrdering) {
        ...
        if (!shouldShowFlips) {
            ...
            let partyStrings = [];
            partyFlipData[currentPartyID] &&
                partyFlipData[currentPartyID].forEach((regionData) => {
                    let formattedRegionMargin =
                        Math.round(regionData.margin * 10) / 10;
                    formattedRegionMargin =
                        currentMapSource.getAddDecimalPadding()
                            ? decimalPadding(formattedRegionMargin)
                            : formattedRegionMargin;
                    partyStrings.push(
                        (currentMapSource.getFormattedRegionName
                            ? currentMapSource.getFormattedRegionName(
            ...
            if (currentDirection == PieChartDirection.clockwise) {
                sortedPartyTotalsArray.push(
                    partyNonFlipTotals[currentPartyID] || 0,
                );
                sortedPartyTotalsArray.push(
                    partyFlipTotals[currentPartyID] || 0,
                );
    ...
    let genericPartyOrderingIndex = fullPartyOrdering.findIndex(
        (orderingData) =>
            orderingData.partyID == IndependentGenericParty.getID(),
    );
    for (let partyTotalNum in partyTotals) {
        sortedPartyTotalsArray[genericPartyOrderingIndex] +=
            partyTotals[partyTotalNum];
    }
    totalsPieChart.data.datasets[1].data = sortedPartyTotalsArray;

    let popularVoteData = getPopularVotePartyVoteshareData(
        regionDataArray,
        shouldGetOriginalMapData,
    );
    const pieStyle = currentMapType.getMapSettings().pieStyle;
    let showingPopularVote =
        popularVoteData &&
        (pieStyle == "popularVote" ||
            pieStyle == "all" ||
            currentMapSource.getShouldForcePopularVoteDisplay() === true ||
            currentMapSource.getShouldForcePopularVoteDisplay() ===
                currentViewingState);
    if (showingPopularVote) {
        let sortedPopularVoteArray = [];
        let summedPercentage = 0;
        for (partyNum in fullPartyOrdering) {
            sortedPopularVoteArray.push(
                (
                    popularVoteData.find(
                        (voteshareData) =>
                            voteshareData.partyID ==
                            fullPartyOrdering[partyNum].partyID,
                    ) || {}
                ).voteshare || 0,
            );
        ...
        if (
            remainingPopularVote > 0 &&
            !(showingCompareMap && currentMapSource.isCompare())
        ) {
            sortedPopularVoteArray[genericPartyOrderingIndex] +=
                remainingPopularVote;
        }
    ...
    let tossupIndex =
        partyOrdering.findIndex(
            (partyOrder) => partyOrder.partyID == TossupParty.getID(),
        ) * 2;
    for (let totalIndex in sortedPartyTotalsArray) {
        if (
            totalIndex % 2 == (totalIndex <= tossupIndex ? 1 : 0) ||
            totalIndex == tossupIndex + 1
        ) {
            continue;
        }
        nonFlipSortedPartyTotalsArray[
            totalIndex / 2 - (totalIndex <= tossupIndex ? 0 : 0.5)
        ] = sortedPartyTotalsArray[totalIndex];
    }

    if (
        safeMarginTotalsArray.toString() ==
            nonFlipSortedPartyTotalsArray.toString() ||
        (showingPopularVote &&
            currentMapType.getMapSettings().pieStyle != "all") ||
    ...
    totalsPieChart.data.datasets[2].backgroundColor =
        preloadedData.datasets[2].backgroundColor;
    totalsPieChart.data.datasets[2].labels = preloadedData.datasets[2].labels;
    totalsPieChart.data.datasets[1].backgroundColor =
        preloadedData.datasets[1].backgroundColor;
    totalsPieChart.data.datasets[1].labels = preloadedData.datasets[1].labels;
    totalsPieChart.data.datasets[0].backgroundColor =
        preloadedData.datasets[0].backgroundColor;
...
function insertPartyIntoTotalsPieChartOrdering(partyID, orderingObject) {
    ...
    if (
        orderingObject.some(
            (partyOrderData) => partyOrderData.partyID == partyID,
        )
    ) {
        return;
    }

    let genericOrderingIndex = orderingObject.findIndex(
        (partyOrderData) =>
            partyOrderData.partyID == IndependentGenericParty.getID(),
    );
    orderingObject.splice(genericOrderingIndex, 0, {
        partyID: partyID,
        direction: PieChartDirection.clockwise,
    });
}
