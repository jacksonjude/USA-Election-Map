...
function updateCountdownTimer()
{
  ...
  $("#countdownDisplay").html("<span style='display: flex; justify-content: center; align-items: baseline; gap: 8rem;'><span>" + (timeHasPassed ? "+" : "–") + "</span><span>" + daysUntilDay + "<span style='font-size: 16rem;'> day" + (daysUntilDay == 1 ? "" : "s") + "</span></span><span>" + zeroPadding(hoursUntilDay) + "<span style='font-size: 16rem;'> hr" + (hoursUntilDay == 1 ? "" : "s") + "</span></span><span>" + zeroPadding(minutesUntilDay) + "<span style='font-size: 16rem;'> min" + (minutesUntilDay == 1 ? "" : "s") + "</span></span><span>" + zeroPadding(secondsUntilDay) + "<span style='font-size: 16rem;'> s" + "</span></span></span>")
}
