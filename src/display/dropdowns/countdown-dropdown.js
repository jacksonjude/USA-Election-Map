...
function updateCountdownTimer()
{
  ...
  $("#countdownDisplay").html("<span style='display: flex; justify-content: center; align-items: baseline; gap: 8px;'><span>" + (timeHasPassed ? "+" : "–") + "</span><span>" + daysUntilDay + "<span style='font-size: 15px;'> day" + (daysUntilDay == 1 ? "" : "s") + "</span></span><span>" + zeroPadding(hoursUntilDay) + "<span style='font-size: 15px;'> hr" + (hoursUntilDay == 1 ? "" : "s") + "</span></span><span>" + zeroPadding(minutesUntilDay) + "<span style='font-size: 15px;'> min" + (minutesUntilDay == 1 ? "" : "s") + "</span></span><span>" + zeroPadding(secondsUntilDay) + "<span style='font-size: 15px;'> s" + "</span></span></span>")
}
